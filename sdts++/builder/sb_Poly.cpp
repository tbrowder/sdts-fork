...
sb_Poly_Imp()
: _ObjectRepresentaion( UNVALUED_STRING )
{}
...
{
  cursubfield->getA( poly_imp._ObjectRepresentaion);
}
else
{
  return false;
...
bool
sb_Poly::getObjectRepresentaion( string & val ) const
{
if ( _imp->_ObjectRepresentaion == UNVALUED_STRING )
return false;

val = _imp->_ObjectRepresentaion;

return true;

} // sb_Poly::getObjectRepresentaion
...
if ( getObjectRepresentaion( tmp_str ) )
{
...
bool
sb_Poly::setObjectRepresentaion( string const& val )
{
_imp->_ObjectRepresentaion = val;

return true;
} // sb_Poly::setObjectRepresentaion
...
void
sb_Poly::unDefineObjectRepresentaion( )
{
_imp->_ObjectRepresentaion = UNVALUED_STRING;
} // sb_Poly::unDefineObjectRepresentaion
